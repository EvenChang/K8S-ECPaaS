...
type Interface interface {
	...
	EvenV1alpha1() evenv1alpha1.EvenV1alpha1Interface
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	evenV1alpha1           *evenv1alpha1.EvenV1alpha1Client
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	cs.evenV1alpha1, err = evenv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	...
	cs.evenV1alpha1 = evenv1alpha1.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	...
	cs.evenV1alpha1 = evenv1alpha1.New(c)
