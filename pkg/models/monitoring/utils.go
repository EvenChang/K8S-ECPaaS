...
var MeterResourceMap = map[string]int{
	...
	"meter_virtualmachine_cpu_usage":             METER_RESOURCE_TYPE_CPU,
	"meter_virtualmachine_memory_usage_wo_cache": METER_RESOURCE_TYPE_MEM,
	"meter_virtualmachine_net_bytes_transmitted": METER_RESOURCE_TYPE_NET_EGRESS,
	"meter_virtualmachine_net_bytes_received":    METER_RESOURCE_TYPE_NET_INGRESS,
	"meter_virtualmachine_pvc_bytes_total":       METER_RESOURCE_TYPE_PVC,
